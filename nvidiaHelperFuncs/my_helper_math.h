...
{
    return make_double3(
        data_array[index + 0 * array_length],
        data_array[index + 1 * array_length],
        data_array[index + 2 * array_length]
        );
}
...
{
    data_array[index + 0 * array_length] = input.x;
    data_array[index + 1 * array_length] = input.y;
    data_array[index + 2 * array_length] = input.z;
}
...
inline __device__ __host__
double3 fma(const double3 &left, const double3 &center, const double3 &right)
{
    double3 result;
    result.x = fma(left.x, center.x, right.x);
    result.y = fma(left.y, center.y, right.y);
    result.z = fma(left.z, center.z, right.z);

    return result;
}

inline __device__ __host__
double3 fma(const double3 &left, const double &center, const double3 &right)
{
    double3 result;
    result.x = fma(left.x, center, right.x);
    result.y = fma(left.y, center, right.y);
    result.z = fma(left.z, center, right.z);

    return result;
}

/////////////////////////////////////////////////////////////////////////////////////
// end double3 Helper functions
/////////////////////////////////////////////////////////////////////////////////////
...
*/
__forceinline__ __device__ float fdiff_of_products (float a, float b, float c, float d)
{
    float w = d * c;
    float e = fmaf (-d, c, w);
    float f = fmaf (a, b, -w);
...
__forceinline__ __device__ double diff_of_products (double a, double b, double c, double d)
{
    double w = d * c;
    double e = fma (-d, c, w);
    double f = fma (a, b, -w);
...
{
    return make_float2((float)s, (float)s);
}
inline __host__ __device__ float2 make_float2(double2 a)
{
    return make_float2((float)a.x, (float)a.y);
}
inline __host__ __device__ float2 make_float2(double3 a)
{
    return make_float2((float)a.x, (float)a.y);
}
inline __host__ __device__ float2 make_float2(double4 a)
{
    return make_float2((float)a.x, (float)a.y);
}
...
inline __host__ __device__ double2 make_double2(double2 a)
{
    return a;
}
...
inline __host__ __device__ double2 make_double2(double4 a)
{
    return make_double2(a.x, a.y);
}

inline __host__ __device__ double2 make_double2(float s)
{
    return make_double2((double)s, (double)s);
}
inline __host__ __device__ double2 make_double2(float2 a)
{
    return make_double2((double)a.x, (double)a.y);
}
inline __host__ __device__ double2 make_double2(float3 a)
{
    return make_double2((double)a.x, (double)a.y);
}
inline __host__ __device__ double2 make_double2(float4 a)
{
    return make_double2((double)a.x, (double)a.y);
}
...
inline __host__ __device__ int2 make_int2(int2 a)
{
    return a;
}
...
inline __host__ __device__ uint2 make_uint2(uint2 a)
{
    return a;
}
...
inline __host__ __device__ uint2 make_uint2(uint4 a)
{
    return make_uint2(a.x, a.y);
}
...
inline __host__ __device__ float3 make_float3(double2 a)
{
...
inline __host__ __device__ float3 make_float3(double2 a, float s)
{
    return make_float3((float)a.x, (float)a.y, (float)s);
}
inline __host__ __device__ float3 make_float3(double4 a)
{
    return make_float3((float)a.x, (float)a.y, (float)a.z);
}
...
inline __host__ __device__ double3 make_double3(float s)
{
    return make_double3((double)s, (double)s, (double)s);
}
inline __host__ __device__ double3 make_double3(float2 a)
{
    return make_double3((double)a.x, (double)a.y, 0.0);
}
...
{
    return make_double3((double)a.x, (double)a.y, (double)s);
}
...
inline __host__ __device__ uint3 make_uint3(uint3 a)
{
    return a;
}
...
inline __host__ __device__ float4 make_float4(double2 a)
{
    return make_float4((float)a.x, (float)a.y, 0.0f, 0.0f);
}
inline __host__ __device__ float4 make_float4(double3 a)
{
    return make_float4((float)a.x, (float)a.y, (float)a.z, 0.0f);
}
inline __host__ __device__ float4 make_float4(double3 a, double w)
{
...
inline __host__ __device__ double4 make_double4(double2 a)
{
    return make_double4(a.x, a.y, 0.0, 0.0);
}
...
{
    return make_double4((double)s, (double)s, (double)s, (double)s);
}
inline __host__ __device__ double4 make_double4(float2 a)
{
    return make_double4((double)a.x, (double)a.y, 0.0, 0.0);
}
inline __host__ __device__ double4 make_double4(float3 a)
{
    return make_double4((double)a.x, (double)a.y, (double)a.z, 0.0);
}
inline __host__ __device__ double4 make_double4(float3 a, float w)
{
    return make_double4((double)a.x, (double)a.y, (double)a.z, (double)w);
}
...
inline __host__ __device__ int4 make_int4(int4 a)
{
    return a;
}
...
inline __host__ __device__ uint4 make_uint4(uint4 a)
{
    return a;
}
...
inline __host__ __device__ double dot(double3 a, double4 b)
{
	return a.x * b.x + a.y * b.y + a.z * b.z;
}
inline __host__ __device__ double dot(double4 a, double3 b)
{
	return a.x * b.x + a.y * b.y + a.z * b.z;
}
